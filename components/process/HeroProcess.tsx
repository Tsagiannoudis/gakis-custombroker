...
const HeroProcess = () => {
  return (
    <section className="relative min-h-screen lg:min-h-[90vh] flex items-center bg-gray-50 pt-32 pb-12 lg:py-64 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-[500px] md:w-[800px] h-[500px] md:h-[800px] bg-red-100/40 rounded-full blur-[120px] -z-10" />
      ...
      <div className="container mx-auto px-6 lg:px-20 z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 mt-12 lg:mt-0">
          ...
          <div className="flex-1 relative w-full max-w-[500px] order-1 lg:order-2">
            <div className="relative aspect-video lg:aspect-square bg-white rounded-[2.5rem] shadow-2xl border-8 border-white overflow-hidden transform lg:rotate-3">
              <div className="absolute inset-0 bg-gradient-to-br from-[#ba283d]/10 to-transparent z-10" />
              <Image
                src="/procesPapers.png" // Μπορείς να χρησιμοποιήσεις μια άλλη εικόνα από το array σου
            ...
            <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-[#ba283d] rounded-3xl -z-10 animate-pulse" />
          </div>
        </div>
        </div>
    </section>
